...
function LandingPresentation() {
  return (
        ...
        <div className="container mx-auto px-4">
            <div className="flex justify-between items-center h-16">
                ...
                <div className="flex items-center">
                    <a href="#" class="text-xl font-bold gradient-text">Academic Hub</a>
                </div>
                
                {/* <!-- Mobile Menu Button --> */}
                <button id="mobileMenuButton" className="md:hidden text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-blue-400">
                ...
                <div id="navLinks" className="hidden md:flex items-center justify-center space-x-6">
                    ...
                    <button onClick="showLoginModal()" class="bg-primary hover:bg-secondary text-white px-4 py-2 rounded-lg transition-colors flex items-center space-x-2 font-medium">
            ...
            {/* <!-- Mobile Menu --> */}
            <div id="mobileMenu" className="hidden md:hidden py-4 space-y-4">
                ...
                <button onclick="showLoginModal()" class="w-full bg-primary hover:bg-secondary text-white px-4 py-2 rounded-lg transition-colors flex items-center justify-center space-x-2 font-medium">
                    <span>Admin Login</span>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"></path>
                    </svg>
    ...
    <div className="fixed top-20 right-6 z-50">
        <button id="darkModeToggle" class="bg-white dark:bg-dark-card text-gray-800 dark:text-white p-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 group">
            <div className="relative">
                <svg className="w-6 h-6 transform transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path className="dark:hidden" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path>
                    <path className="hidden dark:block" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path>
                </svg>
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="index3.html" class="group bg-primary hover:bg-secondary text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2">
    ...
    <div id="loginModal" class="login-modal">
        <div className="container mx-auto px-4 flex items-center justify-center">
            <div className="bg-white dark:bg-dark-card rounded-2xl shadow-2xl max-w-md w-full p-8 transform transition-all duration-300 scale-95 opacity-0" id="modalContent">
                <div className="flex justify-between items-start mb-6">
                    ...
                    <button onclick="hideLoginModal()" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                ...
                <form onSubmit="handleLogin(event)" class="space-y-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" required class="w-full pl-10 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-dark-hover text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent" placeholder="Enter your email"/>
                        </div>
                    </div>
                    <div>
                ...
                <div className="mt-6 text-center space-y-3">
                    <a href="#" class="text-sm text-primary hover:text-secondary dark:text-blue-400 dark:hover:text-blue-300 flex items-center justify-center space-x-1">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"></path>
                        </svg>
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="#" class="text-primary hover:text-secondary dark:text-blue-400 dark:hover:text-blue-300 font-medium">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <button id="devButton" className="fixed bottom-6 right-6 bg-primary hover:bg-secondary text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-2">
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="devCredentials" class="dev-credentials">
        <div className="container mx-auto px-4 py-8 w-full max-w-2xl">
            <div className="bg-white dark:bg-gray-800 rounded-t-3xl shadow-2xl p-8">
                <div className="flex justify-between items-start mb-6">
                    ...
                    <button id="closeDevButton" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                        </svg>
                    </button>
