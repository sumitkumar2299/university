                ...
                <div className="hidden pr-0 lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 md:block">
                    ...
                    <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="firstName" className="text-sm leading-7 text-gray-600"> Name</label>
                            <input 
                                type="text" 
                                id="firstName" 
                                name="firstName" 
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="Current cgpa" className="text-sm leading-7 text-gray-600">Current Cgpa <span className="text-red-500">*</span></label>
                            <input 
                                type="decimal" 
                                id="Current_Cgpa" 
                                name="Current_cgpa" 
